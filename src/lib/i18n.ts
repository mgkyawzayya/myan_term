...
const STRINGS_EN: Record<string, string> = {
  ...
  'profile.manager.label': 'SSH profiles',
  'profile.manager.open': 'Open SSH profiles',
  'error.crash': 'Something went wrong',
  'error.save_failed': 'Save failed',
  'error.settings_reset':
    'Your settings file was corrupted and has been reset to defaults',
  'error.profiles_reset':
    'Your SSH profiles file was corrupted and has been reset to defaults',
  'error.reload_window': 'Reload window',
  'toast.dismiss': 'Dismiss notification',
  'a11y.skip_to_terminal': 'Skip to terminal',
